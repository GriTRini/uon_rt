/* dsr_enum.hpp
 * This file define log group for the dsr project.
 * (log is not defined as type in original DRFC.h)
 */
...
enum class OpenConnError {
    NO_ERROR,
    CREATE_ROBOT_CONTROL_ERROR,
    OPEN_CONNECTION_ERROR,
    INITIALIZE_TP_ERROR,
    MANAGE_ACCESS_CONTROL_ERROR,
    GET_CONTROL_RIGHT_ERROR,
};

enum class ServoOnError {
    NO_ERROR,
    NO_ROBOT_CONTROL_ERROR,
    SET_ROBOT_MODE_ERROR,
    SET_ROBOT_CONTROL_ERROR,
    GET_STATE_STANDBY_ERROR,
    SET_SAFETY_MODE_ERROR,
    GET_ROBOT_STATE_ERROR,
};

enum class ServoOffError {
    NO_ERROR,
    NO_ROBOT_CONTROL_ERROR,
    SET_SERVO_OFF_ERROR,
    GET_ROBOT_STATE_ERROR,
...
enum class CloseConnError {
    NO_ERROR,
    NO_ROBOT_CONTROL_ERROR,
    LOSE_CONTROL_RIGHT_ERROR,
};

enum class ActiveMotion {
    NO_MOTION_IN_ACTION,
    MOTION_BEING_CALCULATED,
    MOTION_IN_OPERATION,
};
...
typedef enum {
    ...
    RC_ERROR_INPUT_INVALID_CONTROL_CMD =
        1908, // Invalid Contorl -> Inverter Command
    RC_ERROR_JTS_CALIBRATION_OUT_OF_RANGE =
        2301, // 210512_YLKim_Addition of Error Code
    RC_ERROR_FTS_CALIBRATION_OUT_OF_RANGE =
        2302, // 210512_YLKim_Addition of Error Code
